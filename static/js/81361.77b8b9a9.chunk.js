...
finalColor.a *= 1.0 - clamp(feather, 0.0, 1.0);`)),D.main.add(S.H`outputColorHighlightOID(finalColor, vpos);`),t}const C=Object.freeze(Object.defineProperty({__proto__:null,build:x,ribbonlineNumRoundJoinSubdivisions:R},Symbol.toStringTag,{value:"Module"}))},17698:(e,t,i)=>{i.d(t,{r:()=>l});var r=i(99443),n=i(3799),o=i(23148),s=i(86955),a=i(50125);function l(e,t){const i=e.vertex;(0,n.Nz)(i),null==i.uniforms.get("markerScale")&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",r.PV).code.add(s.H`float getLineWidth() {
